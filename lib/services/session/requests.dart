...
class Requests {
  ...
  static Map<String, String> extractResponseCookies(responseHeaders) {
    ...
    for (var key in responseHeaders.keys) {
      if (Common.equalsIgnoreCase(key, 'set-cookie')) {
        ...
        cookie.split(';').map((x) => Common.split(x.trim(), '=', max: 1)).where((x) => x.length == 2).where((x) => !_cookiesKeysToIgnore.contains(x[0].toLowerCase())).forEach((x) => cookies[x[0]] = x[1]);
        break;
      }
    }
  ...
  static Future<void> setStoredCookies(String hostname, Map<String, String> cookies) async {
    var hostnameHash = Common.hashStringSHA256(hostname);
  ...
  static Future<Response> head(String url, {Map<String, String>? headers, Map<String, dynamic>? queryParameters, int? port, RequestBodyEncoding bodyEncoding = DEFAULT_BODY_ENCODING, int timeoutSeconds = DEFAULT_TIMEOUT_SECONDS, bool persistCookies = true, bool verify = true}) {
    return _httpRequest(HttpMethod.HEAD, url, bodyEncoding: bodyEncoding, queryParameters: queryParameters, port: port, headers: headers ?? const <String, String>{}, timeoutSeconds: timeoutSeconds, persistCookies: persistCookies, verify: verify);
  }

  static Future<Response> get(String url, {Map<String, String>? headers, Map<String, dynamic>? queryParameters, int? port, json, body, RequestBodyEncoding bodyEncoding = DEFAULT_BODY_ENCODING, int timeoutSeconds = DEFAULT_TIMEOUT_SECONDS, bool persistCookies = true, bool verify = true}) {
    return _httpRequest(HttpMethod.GET, url, bodyEncoding: bodyEncoding, queryParameters: queryParameters, port: port, json: json, body: body, headers: headers ?? const <String, String>{}, timeoutSeconds: timeoutSeconds, persistCookies: persistCookies, verify: verify);
  }

  static Future<Response> patch(String url, {Map<String, String>? headers, int? port, dynamic json, dynamic body, Map<String, dynamic>? queryParameters, RequestBodyEncoding bodyEncoding = DEFAULT_BODY_ENCODING, int timeoutSeconds = DEFAULT_TIMEOUT_SECONDS, bool persistCookies = true, bool verify = true}) {
    return _httpRequest(HttpMethod.PATCH, url, bodyEncoding: bodyEncoding, port: port, json: json, body: body, queryParameters: queryParameters, headers: headers ?? <String, String>{}, timeoutSeconds: timeoutSeconds, persistCookies: persistCookies, verify: verify);
  }

  static Future<Response> delete(String url, {Map<String, String>? headers, dynamic json, dynamic body, Map<String, dynamic>? queryParameters, int? port, RequestBodyEncoding bodyEncoding = DEFAULT_BODY_ENCODING, int timeoutSeconds = DEFAULT_TIMEOUT_SECONDS, bool persistCookies = true, bool verify = true}) {
    return _httpRequest(HttpMethod.DELETE, url, bodyEncoding: bodyEncoding, port: port, json: json, body: body, queryParameters: queryParameters, headers: headers ?? const <String, String>{}, timeoutSeconds: timeoutSeconds, persistCookies: persistCookies, verify: verify);
  }

  static Future<Response> post(String url, {dynamic json, int? port, dynamic body, Map<String, dynamic>? queryParameters, RequestBodyEncoding bodyEncoding = DEFAULT_BODY_ENCODING, Map<String, String>? headers, int timeoutSeconds = DEFAULT_TIMEOUT_SECONDS, bool persistCookies = true, bool verify = true}) {
    return _httpRequest(HttpMethod.POST, url, bodyEncoding: bodyEncoding, json: json, port: port, body: body, queryParameters: queryParameters, headers: headers ?? <String, String>{}, timeoutSeconds: timeoutSeconds, persistCookies: persistCookies, verify: verify);
  }
  ...
  static Future<Response> _httpRequest(HttpMethod method, String url, {dynamic json, dynamic body, RequestBodyEncoding bodyEncoding = DEFAULT_BODY_ENCODING, Map<String, dynamic>? queryParameters, int? port, required Map<String, String> headers, int timeoutSeconds = DEFAULT_TIMEOUT_SECONDS, bool persistCookies = true, bool verify = true}) async {
    http.Client client;
    if (!verify) {
      // Ignore SSL errors
    ...
    if (queryParameters != null) {
      ...
      queryParameters.forEach((key, value) => stringQueryParameters[key] = value is List ? (value.map((e) => e?.toString())) : value?.toString());
    ...
    if (response is http.StreamedResponse) {
      response = await (http.Response.fromStream(response) as FutureOr<http.StreamedResponse>);
    }
